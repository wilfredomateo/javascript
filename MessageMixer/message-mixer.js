//Message Mixer Program
/////////////////////////
//Use: Message encryption that transforms input text, using various ciphers, and displays the encrypted message to the console.
...
function getEncryptionMethod() {
  ...
  if (encryptionType === 'symbol') {
    ...
    process.stdout.write(`Try again with a valid encryption type. Available encryption types: symbol, caesar, or reverse.\n`)
    process.exit();
  }
